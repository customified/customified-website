  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div style={{ position: 'absolute' }} className={`z-20 flex items-center justify-center
        ${canvast === 'front' ? 'top-[85px] left-[0px] right-[5px] bottom-[0px]' : 'top-[85px] left-[0px] right-[5px] bottom-[0px]'}`}>
        <div className={`${canvast === 'back' ? 'hidden' : 'block'}`}>
          <CanvasComponent canvasType='front' height='170' width='125' />
        </div>
     
        <div className={`${canvast === 'front' ? 'hidden' : 'block'}`}>
          <CanvasComponent canvasType='back' height='170' width='125' />
        </div>
     </div>
