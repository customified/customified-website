                ...
                <div className="grid md:grid-cols-3 grid-cols-2 justify-around md:gap-10 gap-5 ">
                    {cat.map(category => (
                        <div
                            ...
                            >
                            <div className="flex flex-col bg-[#ffffff]  md:pb-7 pb-4 self-center items-center justify-center">
                                ...
                                <div className=" w-fit self-center">
                                    ...
                                    <Button
                                        className="bg-[#097392] font-semibold rounded-none text-[12px] md:text-xs px-1.5 py-1 gap-1 text-white flex my-1"
